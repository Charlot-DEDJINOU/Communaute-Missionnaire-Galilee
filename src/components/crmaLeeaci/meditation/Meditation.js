            ...
            <section className="cmra-before-meditation">
                <Container className="d-flex flex-column justify-content-around align-items-center meditation">
                    ...
                    <div className="buttons">
                        <button className="meditation-crmaLeeacibutton" onClick={() => navigate('/inscription')}>Inscrivez vous</button>
                        <button className="meditation-crmaLeeacibutton" onClick={() => navigate('/crmacontact')}>Connectez vous</button>
